...
export default class Menu extends React.Component<Props, any> {
  render() {
    return (
      <div className={`absolute w-10/12 h-full bg-white px-3 bg-neutral-200`}>
        ...
        </div>
        {
          this.props.tasks.map((item, index) => {
            return (
              <div className={`h-16 w-full flex flex-row items-center box-border border-b border-gray-500`}
                   onClick={() => {
                     item.func()
